...
//!
//! This module provides standardized error types used across all layers.
//! These errors can be serialized and sent to the frontend for consistent error handling.
