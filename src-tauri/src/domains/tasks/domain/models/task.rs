...
//! `infrastructure::task_row_mapping` to keep this model free of `rusqlite`
...
// ADR-003: TaskStatus is a cross-domain contract — canonical definition lives
// in `shared::contracts::task_status`. Re-exported here so that existing
// intra-domain imports (`tasks::domain::models::task::TaskStatus`) compile
// without change.
pub use crate::shared::contracts::task_status::TaskStatus;
