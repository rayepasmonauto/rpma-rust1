//! Calendar Repository — raw SQL operations for calendar tasks and scheduling
//!
//! This module contains only database access: no business rules, no response building.
