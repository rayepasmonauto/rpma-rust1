...
impl TaskMaterialTestFixture {
    ...
    pub fn create_test_task_with_materials(
        ...
        let adhesive =
            self.create_test_material_with_stock("ADHESIVE-001", "PPF Adhesive", 10.0)?;
        let cleaner =
            self.create_test_material_with_stock("CLEANER-001", "Surface Cleaner", 5.0)?;
    ...
    pub fn start_intervention_for_task(
        ...
        self.intervention_service
            .get_intervention_by_id(&intervention_response.intervention_id)
    }
    ...
    pub fn get_consumption_for_intervention(
        &self,
        intervention_id: &str,
    ) -> AppResult<Vec<MaterialConsumption>> {
        Ok(self
            .material_service
...
mod tests {
    ...
    async fn test_task_completion_triggers_material_consumption() -> AppResult<()> {
        ...
        let (task, materials) =
            fixture.create_test_task_with_materials("Task with automatic material consumption")?;

        // Start an intervention
        let intervention = fixture
            .start_intervention_for_task(&task, vec!["hood".to_string(), "fender".to_string()])?;

        // Complete all steps with material consumption
        fixture
            .complete_intervention_steps(&intervention, &materials)
            .await?;
    ...
    async fn test_material_stock_levels_properly_updated() -> AppResult<()> {
        ...
        let adhesive =
            fixture.create_test_material_with_stock("STOCK-TEST-ADH", "Adhesive", 25.0)?;
        ...
        let intervention = fixture.start_intervention_for_task(&task, vec!["hood".to_string()])?;
        ...
        fixture
            .material_service
            .record_consumption(film_consumption)?;
        ...
        assert_eq!(updated_film.current_stock, initial_film_stock - 10.0 - 1.5);
    ...
    async fn test_consumption_records_created_with_correct_details() -> AppResult<()> {
        ...
        // Create material
        let material = fixture.create_test_material_with_stock(
            "DETAIL-TEST-001",
            "Detail Test Material",
            30.0,
        )?;
        ...
        let intervention = fixture.start_intervention_for_task(&task, vec!["full".to_string()])?;
    ...
    async fn test_rollback_behavior_if_material_update_fails() -> AppResult<()> {
        ...
        let material =
            fixture.create_test_material_with_stock("LOW-STOCK-001", "Low Stock Material", 1.0)?;
    ...
    async fn test_concurrent_task_completion_handling() -> AppResult<()> {
        ...
        let material1 = fixture.create_test_material_with_stock(
            "CONCURRENT-1",
            "Concurrent Material 1",
            100.0,
        )?;
        let material2 = fixture.create_test_material_with_stock(
            "CONCURRENT-2",
            "Concurrent Material 2",
            100.0,
        )?;
        ...
        let intervention1 =
            fixture.start_intervention_for_task(&task1, vec!["hood".to_string()])?;
        let intervention2 =
            fixture.start_intervention_for_task(&task2, vec!["fender".to_string()])?;
