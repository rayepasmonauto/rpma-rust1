...
export const ipcClient = {
  ...
  clients: {
    ...
    get: (id: string) => mockSafeInvoke<Client | null>("client_get", { id }),
    ...
    listWithTasks: (filters: JsonObject, limitTasks: number) =>
      mockSafeInvoke<Client[]>("client_list_with_tasks", {
        filters,
        limit_tasks: limitTasks,
      }),
    stats: () => mockSafeInvoke<ClientStatistics>("client_get_stats", {}),
    update: (id: string, data: JsonObject) =>
      mockSafeInvoke<Client>("client_update", { id, data }),
    delete: (id: string) => mockSafeInvoke<void>("client_delete", { id }),
  },
  tasks: {
    create: (data: JsonObject) => mockSafeInvoke<Task>("task_create", { data }),
    get: (id: string) => mockSafeInvoke<Task | null>("task_get", { id }),
    update: (id: string, data: JsonObject) =>
      mockSafeInvoke<Task>("task_update", { id, data }),
    list: (filters: JsonObject) =>
      mockSafeInvoke<TaskListResponse>("task_list", { filter: filters }),
    delete: (id: string) => mockSafeInvoke<void>("task_delete", { id }),
    statistics: () => mockSafeInvoke<TaskStatistics>("task_statistics", {}),
    checkTaskAssignment: (_taskId: string, _userId: string) =>
      mockSafeInvoke("check_task_assignment"),
    checkTaskAvailability: (_taskId: string) =>
      mockSafeInvoke("check_task_availability"),
    editTask: (taskId: string, updates: JsonObject) =>
      mockSafeInvoke<Task>("edit_task", {
        request: { task_id: taskId, data: updates },
      }),
    addTaskNote: (taskId: string, note: string) =>
      mockSafeInvoke("add_task_note", { request: { task_id: taskId, note } }),
    sendTaskMessage: (taskId: string, message: string, messageType: string) =>
      mockSafeInvoke("send_task_message", {
        request: { task_id: taskId, message, message_type: messageType },
      }),
    delayTask: (taskId: string, newDate: string, reason: string) =>
      mockSafeInvoke("delay_task", {
        request: { task_id: taskId, new_scheduled_date: newDate, reason },
      }),
    reportTaskIssue: (
      taskId: string,
      issueType: string,
      ...
      mockSafeInvoke("report_task_issue", {
        request: {
          task_id: taskId,
    ...
    exportTasksCsv: (options: JsonObject) =>
      mockSafeInvoke<string>("export_tasks_csv", { request: options }),
    importTasksBulk: (options: JsonObject) =>
      mockSafeInvoke("import_tasks_bulk", { request: options }),
  },
  intervention: {
    ...
    getProgress: (interventionId: string) =>
      mockSafeInvoke("intervention_get_progress", {
  ...
  notifications: {
    initialize: (config: JsonObject) =>
      mockSafeInvoke("initialize_notification_service", { config }),
    send: (request: JsonObject) =>
      mockSafeInvoke("send_notification", { request }),
    getStatus: () => mockSafeInvoke("get_notification_status", {}),
    getRecentActivities: () =>
      mockSafeInvoke<JsonValue[]>("get_recent_activities", {}),
  },
  settings: {
    getAppSettings: () => mockSafeInvoke("get_app_settings", {}),
    updateNotificationSettings: (request: JsonObject) =>
      mockSafeInvoke("update_notification_settings", { request }),
    getUserSettings: () =>
      mockSafeInvoke<UserSettings>("get_user_settings", {}),
    updateUserProfile: (request: JsonObject) =>
      mockSafeInvoke("update_user_profile", { request }),
    updateUserPreferences: (request: JsonObject) =>
      mockSafeInvoke("update_user_preferences", { request }),
    updateUserSecurity: (request: JsonObject) =>
      mockSafeInvoke("update_user_security", { request }),
    updateUserPerformance: (request: JsonObject) =>
      mockSafeInvoke("update_user_performance", { request }),
    updateUserAccessibility: (request: JsonObject) =>
      mockSafeInvoke("update_user_accessibility", { request }),
    updateUserNotifications: (request: JsonObject) =>
      mockSafeInvoke("update_user_notifications", { request }),
    updateGeneralSettings: (request: JsonObject) =>
      mockSafeInvoke("update_general_settings", { request }),
    updateBusinessRules: (rules: JsonValue[]) =>
      mockSafeInvoke("update_business_rules", { request: { rules } }),
    updateSecurityPolicies: (policies: JsonValue[]) =>
      mockSafeInvoke("update_security_policies", { request: { policies } }),
    updateIntegrations: (integrations: JsonValue[]) =>
      mockSafeInvoke("update_integrations", { request: { integrations } }),
    updatePerformanceConfigs: (configs: JsonValue[]) =>
    ...
    revokeAllSessionsExceptCurrent: () =>
      mockSafeInvoke("revoke_all_sessions_except_current", {}),
    updateSessionTimeout: (timeoutMinutes: number) =>
      mockSafeInvoke("update_session_timeout", { timeoutMinutes }),
    getSessionTimeoutConfig: () =>
      mockSafeInvoke("get_session_timeout_config", {}),
  ...
  organization: {
    ...
    uploadLogo: (
      ...
      mockSafeInvoke<Organization>("upload_logo", {
        ...(filePath !== undefined ? { file_path: filePath } : {}),
        ...(base64Data !== undefined ? { base64_data: base64Data } : {}),
      }),
    getSettings: (
      _sessionToken: string,
    ): Promise<Record<string, string | number | boolean>> =>
      mockSafeInvoke<Record<string, string | number | boolean>>(
  ...
  users: {
    create: (data: JsonObject): Promise<JsonValue> =>
      mockSafeInvoke<JsonValue>("user_crud", {
    ...
    list: (limit: number, offset: number): Promise<UserListResponse> =>
      mockSafeInvoke<JsonValue>("user_crud", {
        request: { action: { action: "List", limit, offset } },
      }).then((r) => r as UserListResponse),
    update: (id: string, data: JsonObject): Promise<JsonValue> =>
      mockSafeInvoke<JsonValue>("user_crud", {
        request: { action: { action: "Update", id, data } },
      }),
    delete: (id: string): Promise<void> =>
      mockSafeInvoke<void>("user_crud", {
        request: { action: { action: "Delete", id } },
      }),
    changeRole: (id: string, role: string): Promise<void> =>
      mockSafeInvoke<void>("user_crud", {
        request: { action: { ChangeRole: { id, new_role: role } } },
      }),
    updateEmail: (id: string, email: string): Promise<JsonValue> =>
      mockSafeInvoke<JsonValue>("user_crud", {
        request: { action: { action: "Update", id, data: { email } } },
      }),
    changePassword: (id: string, password: string): Promise<void> =>
      mockSafeInvoke<void>("user_crud", {
        request: { action: { ChangePassword: { id, new_password: password } } },
      }),
    banUser: (id: string): Promise<JsonValue> =>
      mockSafeInvoke<JsonValue>("user_crud", {
        request: { action: { Ban: { id } } },
      }),
    unbanUser: (id: string): Promise<JsonValue> =>
      mockSafeInvoke<JsonValue>("user_crud", {
        request: { action: { Unban: { id } } },
      }),
  },
  bootstrap: {
    firstAdmin: (userId: string) =>
      mockSafeInvoke("bootstrap_first_admin", { request: { user_id: userId } }),
  ...
  audit: {
    ...
    getEvents: (limit: number) =>
      mockSafeInvoke("get_security_events", { limit }),
    getAlerts: () => mockSafeInvoke("get_security_alerts", {}),
    acknowledgeAlert: (alertId: string) =>
      mockSafeInvoke("acknowledge_security_alert", { alert_id: alertId }),
  },
  calendar: {
    getEvents: (startDate: string, endDate: string, technicianId?: string) =>
      mockSafeInvoke("get_events", {
        start_date: startDate,
        end_date: endDate,
        ...(technicianId !== undefined ? { technician_id: technicianId } : {}),
      }),
    getEventById: (id: string) =>
      mockSafeInvoke("get_event_by_id", { request: { id } }),
    createEvent: (eventData: JsonObject) =>
      mockSafeInvoke("create_event", { request: { event_data: eventData } }),
    updateEvent: (id: string, eventData: JsonObject) =>
      mockSafeInvoke("update_event", {
        request: { id, event_data: eventData },
      }),
    deleteEvent: (id: string) =>
      mockSafeInvoke("delete_event", { request: { id } }),
    getEventsForTechnician: (technicianId: string) =>
      mockSafeInvoke("get_events_for_technician", {
        request: { technician_id: technicianId },
      }),
    getEventsForTask: (taskId: string) =>
      mockSafeInvoke("get_events_for_task", { request: { task_id: taskId } }),
  },
  photos: {
    list: (interventionId: string) =>
      mockSafeInvoke("document_get_photos", {
    ...
    upload: (
      ...
      mockSafeInvoke("document_store_photo", {
        request: {
          intervention_id: interventionId,
          file_name: file.name,
        ...
        image_data: Array.from(file.bytes) as number[],
      }),
    delete: (photoId: string) =>
      mockSafeInvoke("document_delete_photo", { photo_id: photoId }),
  },
  material: {
    list: (query: JsonObject) => mockSafeInvoke("material_list", query),
    create: (data: JsonObject) =>
      mockSafeInvoke("material_create", { request: data }),
    update: (id: string, data: JsonObject) =>
      mockSafeInvoke("material_update", { id, request: data }),
    get: (id: string) => mockSafeInvoke("material_get", { id }),
    delete: (id: string) => mockSafeInvoke("material_delete", { id }),
    updateStock: (data: JsonObject) =>
      mockSafeInvoke("material_update_stock", { request: data }),
    adjustStock: (data: JsonObject) =>
      mockSafeInvoke("material_adjust_stock", { request: data }),
    recordConsumption: (data: JsonObject) =>
      mockSafeInvoke("material_record_consumption", { request: data }),
    getConsumptionHistory: (materialId: string, query: JsonObject) =>
      mockSafeInvoke("material_get_consumption_history", {
        material_id: materialId,
        ...query,
      }),
    createInventoryTransaction: (data: JsonObject) =>
      mockSafeInvoke("material_create_inventory_transaction", {
        request: data,
      }),
    getTransactionHistory: (materialId: string, query: JsonObject) =>
      mockSafeInvoke("material_get_transaction_history", {
        material_id: materialId,
        ...query,
      }),
    createCategory: (data: JsonObject) =>
      mockSafeInvoke("material_create_category", { request: data }),
    listCategories: () => mockSafeInvoke("material_list_categories", {}),
    createSupplier: (data: JsonObject) =>
      mockSafeInvoke("material_create_supplier", { request: data }),
    listSuppliers: () => mockSafeInvoke("material_list_suppliers", {}),
    getStats: () => mockSafeInvoke("material_get_stats", {}),
    getLowStockMaterials: () =>
      mockSafeInvoke("material_get_low_stock_materials", {}),
    getExpiredMaterials: () =>
      mockSafeInvoke("material_get_expired_materials", {}),
    getInventoryMovementSummary: (materialId: string) =>
      mockSafeInvoke("material_get_inventory_movement_summary", {
        material_id: materialId,
      }),
  },
} as const;
