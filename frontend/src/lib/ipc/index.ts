import {
  ipcClient as realIpcClient,
  useIpcClient as realUseIpcClient,
} from "./client";
import {
  ipcClient as mockIpcClient,
  useIpcClient as mockUseIpcClient,
  installMockControls,
...
export const useIpcClient = (
  useMock ? mockUseIpcClient : realUseIpcClient
) as typeof realUseIpcClient;
...
export { showSaveDialog, listenToEvent, isTauriEnvironment } from "./platform";
export type { SaveDialogOptions, EventCallback, UnlistenFn } from "./platform";
