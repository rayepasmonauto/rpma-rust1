    ...
    <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-5 shadow-sm hover:shadow transition-shadow duration-200">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-start">
          ...
          <div>
            <p className="text-sm text-border">Date prévue</p>
            <p className="text-base font-medium text-foreground">
              {task.scheduled_date
                ? formatDate(task.scheduled_date, 'EEEE d MMMM')
                : 'Non définie'}
            </p>
            {task.scheduled_date && (
              <p className="text-sm text-border mt-0.5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="bg-gray-50 p-3 rounded-lg">
            <div className="flex items-center text-sm text-border mb-1">
            ...
            {task.start_time ? (
              ...
              <p className="text-sm text-border italic">Non commencé</p>
            )}
          </div>
          ...
          <div className="bg-gray-50 p-3 rounded-lg">
            ...
            {task.end_time ? (
              ...
              <p className="text-sm text-border italic">Non terminé</p>
            )}
          </div>
        </div>
        ...
        {task.start_time && task.end_time && (
          <div className="pt-2 border-t border-gray-100">
            <div className="flex items-center text-sm text-border">
              <Clock className="h-4 w-4 mr-1.5 text-gray-400" />
              Durée
            </div>
