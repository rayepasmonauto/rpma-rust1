...
export function TaskDetails({
  ...
  const handleAssignToMe = async () => {
    ...
    try {
      await updateTask.mutateAsync({
        taskId: task.id,
        data: createTechnicianUpdate(user.id),
      });
      onTaskUpdated();
    } catch (error) {
