        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-center gap-3 md:gap-4 min-w-0 flex-1">
              <div className={cn('p-2 md:p-3 rounded-lg md:rounded-xl border border-border/10 bg-muted/10 flex-shrink-0')}>
        ...
        <div className="space-y-3 md:space-y-4">
          ...
          {client.notes && (
            <div className="pt-4 border-t border-border/10">
              ...
              <p className="text-sm text-foreground line-clamp-2 leading-relaxed">{client.notes}</p>
            </div>
          )}
            ...
            <div className="pt-4 border-t border-border/10">
              ...
              <div className="space-y-2">
                {tasks.slice(0, 3).map((task) => (
                  <div
                    key={task.id}
                    className="flex items-center justify-between p-3 bg-muted/5 border border-border/10 hover:bg-muted/10 hover:border-border/20 transition-colors duration-200 rounded-lg"
                  >
