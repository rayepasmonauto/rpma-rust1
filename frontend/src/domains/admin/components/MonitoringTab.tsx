...
export function MonitoringTab() {
  ...
  type HealthComponent = { status: string; message?: string; lastChecked: string };
  const componentEntries: Array<[string, HealthComponent]> = systemStatus
    ? Object.entries(systemStatus.components as Record<string, HealthComponent>)
    : [];
